...
interface AddInfoBlockProps {
    error: string,
    film: Film,
    setFilm?: (value: (((prevState: Film) => Film) | Film)) => void
}

const AddInfoBlock: React.FC<AddInfoBlockProps> = ({error, film, setFilm}) => {
        return (
            <div className="addInfoBlock">
                ...
                {(!film.details?.title) ? error && <div className="alertDanger"><i>{error}</i></div> : <p></p>}
                <TextField
                ...
                {(!film.details.fullDescription) ? error && < div className="alertDanger">< i> {error}</i></div> : <p></p>
                }
                <div className="btns">
